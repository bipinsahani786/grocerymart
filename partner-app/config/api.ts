...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    PARTNER: {
      ...
      ORDERS_INCOMING: '/api/partner/orders/incoming',
      ORDERS_ACCEPT: (orderId: string) => `/api/partner/orders/${orderId}/accept`,
      ORDERS_REJECT: (orderId: string) => `/api/partner/orders/${orderId}/reject`,
      ORDERS_ACTIVE: '/api/partner/orders/active',
      ORDERS_STATUS: (orderId: string) => `/api/partner/orders/${orderId}/status`,
      ORDERS_COMPLETE: (orderId: string) => `/api/partner/orders/${orderId}/complete`,
      ORDERS_TRIPS: '/api/partner/orders/trips',
    },
    UPLOAD: '/api/upload',
  },
