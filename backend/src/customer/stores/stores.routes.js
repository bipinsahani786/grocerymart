...
// GET /api/customer/stores/nearby & GET /api/customer/stores/nearest
router.get("/nearby", customerStoresController.getNearbyStore);
router.get("/nearest", customerStoresController.getNearbyStore);
